...
def splitdata(datafile,P,unum):
    #spliteddata=np.empty((P,rnum+1,4),int)
    upnum=unum/P+1;
...
def dsadmm(up,vp,v_ave,unum,inum,rnum,comm,rank,size,k,P,start,testnum):
...
if __name__=='__main__':
    ...
    dsadmm(up,vp,v_ave,unum,inum,rnum,comm,rank,size,k,P,start,testnum=10000)
    end=time.clock()
    if rank==0:
        print(end-start)
